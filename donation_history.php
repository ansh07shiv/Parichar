...
if($mysql->connect_error)
{
	...
	if ($result = $mysql->query("SELECT   p.title,p.type,p.description,d.amount,d.name,d.email,d.mobile,d.timedate  from donation_details as d , problem_statements as p where p.id=d.problem_id"))
	{
